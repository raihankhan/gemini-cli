...
import { AuthType, type Config } from '@google/coder-cli-core';
...
import { clearCachedCredentialFile } from '@google/coder-cli-core';
import { Text } from 'ink';

// Mocks
vi.mock('@google/coder-cli-core', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@google/coder-cli-core')>();
  return {
    ...actual,
...
describe('AuthDialog', () => {
  ...
  it('selects initial auth type from CODER_API_KEY env var', () => {
