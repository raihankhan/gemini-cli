...
} from '@google/coder-cli-core/src/ide/types.js';
...
const IDE_SERVER_PORT_ENV_VAR = 'CODER_CLI_IDE_SERVER_PORT';
const IDE_WORKSPACE_PATH_ENV_VAR = 'CODER_CLI_IDE_WORKSPACE_PATH';
